...
**毫米波生命体征监测系统 (Millimeter-wave Monitoring Device)** 是一个新一代的非接触式生理信号监测平台。它利用 **TI AWR1843** 调频连续波 (FMCW) 雷达技术，通过捕捉人体胸壁微米级的微小位移，实现无感知的 **心震图 (SCG)**、**呼吸波形** 以及 **心率** 监测。
